...
* */
    ...
    public CalendarDTO(int memNum, int id, String groupId, String title, String content, String start, String end, String allDay, String color, String type, Date wDate) {
